...
public class EnemySpawner : MonoBehaviour
{
    ...
    [SerializeField] private Transform[] defaultSpawnPoints; // LevelData yoksa kullanılacak
    ...
    private Transform[] GetActiveSpawnPoints(LevelData lvl)
    {
        // LevelData’da tanımlı spawnPoints varsa onları kullan
        if (lvl != null && lvl.spawnPoints != null && lvl.spawnPoints.Length > 0)
            return lvl.spawnPoints;

        // Aksi halde varsayılan spawn point'leri kullan
    ...
    private void SpawnOne(LevelData lvl)
    {
        ...
        var spList = GetActiveSpawnPoints(lvl);
    ...
    {
        // BoxCollider varsa rastgele nokta
        ...
        // Collider yoksa transform pozisyonu
